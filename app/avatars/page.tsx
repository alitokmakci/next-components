  ...
  return (
    <div className="flex flex-col items-center py-16 bg-gray-100">
      <Container className="space-y-6">
        <h1 className="mx-auto text-center">Avatars</h1>

        <h2 className="mx-auto text-center">Colors:</h2>
        ...
        <h2 className="mx-auto text-center">Flat:</h2>
        ...
        <h2 className="mx-auto text-center">Square:</h2>
        ...
        <h2 className="mx-auto text-center">Circle:</h2>
        ...
        <h2 className="mx-auto text-center">Sizes:</h2>
        ...
        <h2 className="mx-auto text-center">Image:</h2>
        ...
        <h2 className="mx-auto text-center">Avatar Badges:</h2>
        ...
        <h2 className="mx-auto text-center">Badge Colors:</h2>
        ...
        <h2 className="mx-auto text-center">Badge Positions:</h2>
        ...
        <h2 className="mx-auto text-center">Badge Content:</h2>
